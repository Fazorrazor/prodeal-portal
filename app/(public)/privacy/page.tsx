...
export const metadata = {
  title: 'Privacy Policy | Pro Deal Industries Limited',
  description: 'Privacy policy and data handling practices for Pro Deal Industries Limited.',
};
    ...
    <div className="container mx-auto max-w-4xl px-2 sm:px-6 lg:px-8 py-16 md:py-24">
      ...
      <div className="space-y-12 text-brand-deep-blue leading-relaxed font-mono text-sm md:text-base">
        <div className="bg-brand-deep-blue/5 p-6 border-l-2 border-brand-deep-blue">
          ...
          <p>
            This policy is issued on behalf of Pro Deal Industries Limited Data processing is governed in accordance with the Data Protection Act, 2012 (Act 843) of the Republic of Ghana, alongside applicable international B2B data protection standards.
          </p>
        </div>
        ...
        <section>
          ...
          <p className="mb-4">
            Pro Deal Industries Limited ("we," "our," or "us") is committed to protecting your privacy. We collect minimal personal information necessary to facilitate B2B inquiries and communication. The information we collect may include your name, company name, email address, and WhatsApp-enabled phone number.
          </p>
          <p>
