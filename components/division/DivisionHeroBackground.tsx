...
const DIVISION_IMAGES = {
  signages: [
    'https://images.unsplash.com/photo-1563203369-26f2e4a5ccf7?auto=format&fit=crop&w=1920&q=80',
  ...
  printing: [
    ...
    'https://images.unsplash.com/photo-1588693959306-444cb3f9e9d1?auto=format&fit=crop&w=1920&q=80',
  ],
  bowls: [
